...
public class BrowserUtilities {
    ...
    // 2. Create a method to make Multiple Windows logic re-usable 3. When method is
    // called, it should switch window and verify
    // title.
    ...
    public static void switchWindowAndVerify(String expectedInUrl, String expectedTitle) {
        ...
        for (String eachWindow : allWindowHandles) {
            // driver.switchTo().window(eachWindow); syntax will switch each windows and
            // driver will be able to see each window
    ...
    /**
     * This method locate if the button one is on the left
     * 
     * @param buttonOne
     * @param buttonTwo
     * @return
